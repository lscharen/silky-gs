...
Abs  EXT
Anim_EndWriteSprite  EXT
Anim_SetSpriteDescriptorAttributes  EXT
Anim_SetSpriteDescriptorRedPaletteRow  EXT
Anim_WriteItemSprites  EXT
Anim_WriteLevelPaletteSprite  EXT
Anim_WriteSpecificSprite  EXT
Anim_WriteSprite  EXT
Anim_WriteStaticItemSpritesWithAttributes  EXT
AnimateWorldFading  EXT
BoundByRoom  EXT
BoundByRoomWithA  EXT
BoundDirectionHorizontally  EXT
BoundDirectionVertically  EXT
CheckLinkCollision  EXT
CheckLinkCollisionPreinit  EXT
CheckMonsterArrowOrRodCollision  EXT
CheckMonsterBombOrFireCollision  EXT
CheckMonsterCollisions  EXT
CheckMonsterSwordCollision  EXT
CheckMonsterSwordShotOrMagicShotCollision  EXT
CycleCurSpriteIndex  EXT
DealDamage  EXT
...
GetShortcutOrItemXYForRoom  EXT
Negate  EXT
Person_Draw  EXT
PlaySample  EXT
...
; .INCLUDE "ObjVars.inc" (hoisted to file header)
...
_InitMonsterShot_Unknown54 ENT
...
FireballQSpeedsX
            db    $70, $68, $60, $58, $50, $3C, $26, $10

FireballQSpeedsY
            db    $00, $10, $26, $3C, $50, $58, $60, $68
            db    $70
...
UpdateZolState_JumpTable
            dw    UpdateZolState0_Wander
            dw    UpdateZolState1_Shove
            dw    UpdateZolState2_Split
...
;
StatueXs
            db    $24, $C8, $24, $C8, $64, $88, $48, $A8

; A list of coordinates divided into sets for each pattern.
;
StatueYs
            db    $C0, $BC, $64, $5C, $94, $8C, $82, $86
...
InitSlowOctorockOrGhini ENT
    ; Assign QSpeed $20 (0.5 pixels a frame).
    LDA #$20
    BNE :Anon0035

InitFastOctorock ENT
...
JumperYAccelerations
            ...
            db    $00, $30, $30, $00, $80, $80, $00, $00
            db    $80, $80, $00, $00, $50, $50, $60, $60
            db    $60, $60, $60, $60, $60
...
BlueLeeverStateQSpeeds
            db    $08, $0A, $10, $20, $10, $0A

BlueLeeverStateTimes
            db    $80, $20, $0F, $FF, $10, $60

BlueLeeverStateAnimTimes
            db    $10, $0B, $01, $05, $01, $0B

UpdateBlueLeever ENT
    LDA #$A0                    ; Turn rate $A0
    STA ObjTurnRate, X
    JSR Wanderer_TargetPlayer
...
RedLeeverStateTimes
            db    $00, $10, $08, $FF, $08, $10

RedLeeverStateAnimTimes
            db    $10, $08, $08, $05, $08, $08
...
SecretArmosRoomIds
            db    $24, $0B, $1C, $22, $34, $3D, $4E

SecretArmosXs
            db    $E0, $B0, $B0, $30, $40, $90, $A0

InitArmosOrFlyingGhini ENT
...
;
RevealAndFlagSecretStairsObj ENT
...
Flyer_GhiniDecideState
    ...
    LDA Random, X
    CMP #$A0
    BCS :Anon0061                      ; If >= $A0, go to state 2.
    INY
    CMP #$08
    BCS :Anon0061                      ; If >= 8, go to state 3.
    INY                         ; Else go to state 4.
:Anon0061
...
WallmasterDirsAndAttrsLeft
            db    $01, $01, $08, $08, $08, $02, $02, $02
            db    $C1, $C1, $C4, $C4, $C4, $C2, $C2, $C2

WallmasterDirsAndAttrsRight
            db    $42, $42, $48, $48, $48, $41, $41, $41
            db    $82, $82, $84, $84, $84, $81, $81, $81

WallmasterDirsAndAttrsTop
            db    $C4, $C4, $C2, $C2, $C2, $C8, $C8, $C8
            db    $84, $84, $81, $81, $81, $88, $88, $88

WallmasterDirsAndAttrsBottom
            db    $48, $48, $42, $42, $42, $44, $44, $44
            db    $08, $08, $01, $01, $01, $04, $04, $04
...
Digdogger_ChangeSpeed_JumpTable
            dw    Digdogger_SpeedUp
            dw    Digdogger_SlowDown
...
UpdateDodongoState_JumpTable
            dw    UpdateDodongoState0_Move
            dw    UpdateDodongoState1_Bloated
            dw    UpdateDodongoState2_Stunned
...
UpdateDodongoState1_Bloated_JumpTable
            dw    UpdateDodongoState1_Bloated_Sub_Wait
            dw    UpdateDodongoState1_Bloated_Sub_Wait
            dw    UpdateDodongoState1_Bloated_Sub_Wait
            dw    UpdateDodongoState1_Bloated_Sub_Die
            dw    UpdateDodongoState1_Bloated_Sub_End
...
;
DodongoFrameImages
            db    $00, $01, $06, $FF, $08, $02, $03, $06
            db    $FF, $08

DodongoFrameHFlips
            db    $00, $40, $00, $FF, $00, $00, $40, $40
            db    $FF, $40

DodongoFrameImagesBloated
            db    $04, $05, $07, $FF, $09, $04, $05, $07
            db    $FF, $09

DodongoFrameHFlipsBloated
            db    $00, $40, $00, $FF, $00, $00, $40, $00
            db    $FF, $00
...
PolsVoiceWalkSpeedsX
            db    $01, $FF, $00, $00, $01, $FF, $00, $00
            db    $01, $FF

PolsVoiceWalkSpeedsY
            db    $00, $00, $00, $01, $01, $01, $00, $FF
            db    $FF, $FF

PolsVoiceInitialJumpSpeeds
            db    $FD, $FD, $FF, $FF, $FF, $FF, $FF, $FC

PolsVoiceDestinationYOffsets
            db    $00, $00, $20, $20, $20, $20, $20, $E0
...
VireJumpOffsets
            db    $00, $FD, $FE, $FF, $FF, $00, $FF, $00
            db    $00, $01, $00, $01, $01, $02, $03, $00
...
WizzrobeCollisionOffsetsX
            db    $0F, $00, $00, $04, $08, $00, $00, $04
            db    $08, $00

WizzrobeCollisionOffsetsY
            db    $04, $04, $00, $08, $08, $08, $00, $F8
            db    $00, $00
...
UpdateRedWizzrobe_JumpTable
            dw    UpdateRedWizzrobe_0
            dw    UpdateRedWizzrobe_1
            dw    UpdateRedWizzrobe_2
            dw    UpdateRedWizzrobe_3

RedWizzrobeOffsetsX
            db    $00, $00, $E0, $20, $00, $00, $C0, $40
            db    $00, $00, $D0, $30, $00, $00, $B0, $50

RedWizzrobeOffsetsY
            db    $E0, $20, $00, $00, $C0, $40, $00, $00
            db    $D0, $30, $00, $00, $B0, $50, $00, $00
...
Gohma_HandleWeaponCollision ENT
...
ControlGleeokHeadFlight_JumpTable
            dw    Flyer_SpeedUp
            dw    Flyer_GleeokHeadDecideState
            dw    Flyer_Chase
            dw    Flyer_Wander
...
Gleeok_StretchNeck_JumpTable
            dw    Gleeok_ExpandSegment
            dw    Gleeok_IgnoreSegment
            dw    Gleeok_ContractSegmentX
            dw    Gleeok_IgnoreSegment
            dw    Gleeok_IgnoreSegment
            dw    Gleeok_ContractSegmentX
            dw    Gleeok_ContractSegmentY
            dw    Gleeok_ContractSegmentY
            dw    Gleeok_ContractSegment
...
GleeokBodyTiles0
            db    $C0, $C4, $C8, $C2, $C6, $CA

GleeokBodyTiles1
            db    $CC, $C4, $CE, $C2, $C6, $D0

GleeokBodyTiles2
            db    $D2, $D6, $D8, $D4, $C6, $D0
...
UpdateGanon_JumpTable
            dw    Ganon_ScenePhase0
            dw    Ganon_ScenePhase1
            dw    Ganon_ScenePhase2
...
GanonBurstSpriteAttrs
            db    $00, $00, $40, $00, $80, $C0, $80, $00
            db    $40, $00

GanonBurstTiles
            db    $00, $00, $EE, $EE, $E8, $30, $30, $E8
            db    $30, $30
...
GanonFrameImages
            db    $06, $08, $07, $09, $00, $00, $01, $01
            db    $02, $02, $03, $03, $04, $00, $05, $01
            db    $04, $04, $05, $05, $00, $04, $01, $05
...
;
NoDropMonsterTypes
            db    $5D, $14, $15, $1B, $1C, $1D, $17

DropItemMonsterTypes0
            db    $07, $08, $0E, $04, $0F, $23

DropItemMonsterTypes1
            db    $21, $22, $0D, $10, $13, $28, $2A, $27
            db    $16

DropItemMonsterTypes2
            db    $09, $0A, $03, $01, $12, $06, $0B, $24
            db    $30
...
;
DropItemTable
            db    $22, $18, $22, $18, $23, $18, $22, $22
            db    $18, $18, $0F, $18, $22, $18, $0F, $22
            db    $21, $18, $18, $18, $22, $00, $18, $21
            db    $18, $22, $00, $18, $00, $22, $22, $22
            db    $23, $18, $22, $23, $22, $22, $22, $18

SetUpDroppedItem ENT
...
UpdateCandle_JumpTable
            dw    UpdateCandle_Begin
            dw    UpdateCandle_Brightening
            dw    UpdateCandle_Done
...
Flyer_CompareMaxSpeed
    ...
    BCC :Anon0173                      ; If (whole_speed & $E0) < threshold, return.
