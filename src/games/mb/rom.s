...
JMP_IND_0014            JMP_ABS_IND $14
LDA_BumpBlockVars_Y     LDA_ABS_Y {BumpBlockVars}
STA_BumpEntityVars_m1_Y STA_ABS_Y {BumpEntityVars-1}
STA_BumpEntityVars_Y    STA_ABS_Y {BumpEntityVars}
CMP_BumpEntityVars_p1_Y CMP_ABS_Y {BumpEntityVars+1}
CMP_BumpEntityVars_p2_Y CMP_ABS_Y {BumpEntityVars+2}
STA_BumpEntityVars_p1_Y STA_ABS_Y {BumpEntityVars+1}
STA_BumpBlockVars_Y     STA_ABS_Y {BumpBlockVars}
LDA_ScoreAddress_Y      LDA_ABS_Y {ScoreAddress}
LDA_HighScore_m1_Y      LDA_ABS_Y {HighScore-1}
LDA_PlayerScore_m1_Y    LDA_ABS_Y {PlayerScore-1}
LDA_HighScore_Y         LDA_ABS_Y {HighScore}
LDA_HighScore_p1_Y      LDA_ABS_Y {HighScore+1}
LDA_HighScore_p2_Y      LDA_ABS_Y {HighScore+2}
LDA_PlayerScore_p2_Y    LDA_ABS_Y {PlayerScore+2}
STA_CurrentEntity_Address_Y STA_ABS_Y {CurrentEntity_Address}
...
;   BEQ CODE_D5E1				;
   jsl yield               ; InterruptedFlag is on zero page, so this replaces exactly 4 bytes
...
;   STA CurrentEntity_Address,Y			;
   jsr STA_CurrentEntity_Address_Y
...
ChannelFrequencyLookup_F900
  ddb $01C4,$0000,$0069,$00D4
  ddb $00C8,$00BD,$00B2,$00A8
  ddb $009F,$008D,$0085,$007E
  ddb $0076,$0070,$01AB,$017C
  ddb $0167,$0152,$013F,$011C
  ddb $010C,$00FD,$00EE,$00E1
  ddb $0357,$02F9,$02A6,$0280
  ddb $023A,$021A,$01FC,$01DF
  ddb $06AE,$05F3,$054D,$0501
  ddb $0475,$0389,$0053
