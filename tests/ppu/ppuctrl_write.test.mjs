...
// 32KB covers 16KB VRAM ($0000-$3FFF) + 16KB tile-version shadow ($4000-$7FFF).
const STUBS = `\
PPU_MEM              ds    $8000
...
// Only reached by PPUDATA_WRITE for palette writes ($3F00+); entries point
// to a no-op stub so all 32 slots are covered.
const PAL_DISPATCH = `\
pal_stub             rts
