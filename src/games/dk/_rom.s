...
LDA_PhaseNo_Y LDA_ABS_Y PhaseNo
STA_Barrel_CurrentPlatformIndex_Y STA_ABS_Y Barrel_CurrentPlatformIndex
LDA_Barrel_GFXFrame_Y LDA_ABS_Y Barrel_GFXFrame
STA_EntitiesPerPlatform_Y STA_ABS_Y EntitiesPerPlatform
LDA_Barrel_CurrentPlatformIndex_Y LDA_ABS_Y Barrel_CurrentPlatformIndex
LDA_Bolt_RemovedFlag_Y LDA_ABS_Y Bolt_RemovedFlag
...
LOOP_C7A8
  JSR LDA_2002				;wait untill NES is powered full and well
  AND #$80					;
;  BEQ LOOP_C7A8					;
  NOP
...
;  STA Barrel_CurrentPlatformIndex,Y		;depending on current platform, go left or right
  JSR STA_Barrel_CurrentPlatformIndex_Y
  AND #$01					;
...
;  LDA Barrel_CurrentPlatformIndex,Y		;is barrel even alive? (if platform value is 0, most likely not)
  JSR LDA_Barrel_CurrentPlatformIndex_Y
...
;ClearScreen_F1B4
CODE_F1B4
  JSR LDA_2002				;write during V-blank                
...
;  LDA Score_InvertOperandFlag,Y			;TOP sub/add invert flag? similar to similar addresses for normal score calculation
  JSR LDA_Score_InvertOperandFlag_Y
  BNE CODE_F4A9					;
