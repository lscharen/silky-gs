; ld65 segment-boundary constants (see KNOWN_LINKER_CONSTANTS in convert.py)
__BANK_01_CODE_LOAD__  EQU   CommonCodeBlock_Bank1
...
InitMode_EnterRoom  EXT
ResetInvObjState  EXT
...
; .INCLUDE "CaveVars.inc" (hoisted to file header)
...
PersonTextAddrs
            use   dat/PersonTextAddrs.inc

PersonText
            putbin dat/PersonText.dat
...
MoneyGamePermutations
            db    $00, $01, $02, $01, $02, $00, $02, $00
            db    $01, $00, $02, $01, $02, $01, $00, $01
            db    $00, $02
...
PriceListTemplateTransferBuf
            db    $22, $C8, $0D, $21, $24, $24, $24, $24
            db    $24, $24, $24, $24, $24, $24, $24, $24
            db    $FF

UpdateCavePerson ENT
...
UpdateCavePerson_JumpTable
            dw    UpdateCavePersonState_TransferPrices
            dw    UpdatePersonState_Textbox
            dw    UpdateCavePersonState_TalkOrShopOrDoorCharge
            dw    UpdatePersonState_CueTransferBlankPersonWares
            dw    UpdatePersonState_DelayThenHide
            dw    UpdateCavePersonState_HintOrMoneyGame
            dw    UpdatePersonState_CueTransferBlankPersonWares
            dw    UpdatePersonState_Textbox
            dw    UpdateCavePersonState_DoNothing
...
InitUnderworldPerson_Full_JumpTable
            dw    InitUnderworldPerson_DoNothing
            dw    InitUnderworldPersonA
            dw    InitUnderworldPersonA
            dw    InitUnderworldPersonB
            dw    InitUnderworldPersonB
            dw    InitUnderworldPersonA
            dw    InitUnderworldPersonB
            dw    InitUnderworldPersonA
            dw    InitUnderworldPersonB
            dw    InitUnderworldPersonC

UnderworldPersonTextSelectorsA
            db    $28, $26, $2E, $30, $32, $3E, $3E, $34
...
InitUnderworldPersonLifeOrMoney_Full ENT
    ; The person goes at location ($78, $80).
    LDA #$78
    LDY #$80
    JSR SetUpCommonCaveObjects
...
UpdateUnderworldPerson_Full ENT
...
UpdateUnderworldPerson_Full_JumpTable
            dw    UpdatePersonState_ResetCharOffset
            dw    UpdatePersonState_Textbox
            dw    UpdatePersonState_DoNothing
...
UpdateUnderworldPersonComplex_JumpTable
            dw    UpdateUnderworldPersonComplexState_Begin
            dw    UpdatePersonState_Textbox
            dw    UpdateUnderworldPersonComplexState_SenseLink
            dw    UpdatePersonState_CueTransferBlankPersonWares
            dw    UpdateUnderworldPersonComplexState_DelayAndQuit
...
UpdateUnderworldPersonLifeOrMoney_Full ENT
...
UpdateUnderworldPersonLifeOrMoney_Full_JumpTable
            dw    UpdateUnderworldPersonLifeOrMoneyState_0
            dw    UpdatePersonState_Textbox
            dw    UpdateUnderworldPersonLifeOrMoneyState_2
            dw    UpdatePersonState_CueTransferBlankPersonWares
            dw    UpdateUnderworldPersonComplexState_DelayAndQuit
...
DemoPatternBlockAddrs
            dw    DemoSpritePatterns
            dw    DemoBackgroundPatterns
...
DemoSpritePatterns
            putbin dat/DemoSpritePatterns.dat

DemoBackgroundPatterns
            putbin dat/DemoBackgroundPatterns.dat
...
WhirlwindPrevRoomIdList
            db    $36, $3B, $73, $44, $0A, $21, $41, $6C

UpdateWhirlwind_Full ENT
...
TeleportYs
            db    $8D, $AD, $8D, $8D, $AD, $8D, $AD, $5D

CheckInitWhirlwindAndBeginUpdate ENT
    LDA WhirlwindTeleportingState
    BEQ :Anon0022                      ; If not teleporting, go start updating the mode.
...
:ChooseObjType
    ...
    CPY #$C0
    BCS :Anon0027                      ; If tile >= $C0, then instantiate an armos.
    LDA #$22                    ; Flying Ghini
:Anon0027
    STA ObjType, X
...
RupeeStashXs
            db    $78, $70, $80, $60, $70, $80, $90, $70
            db    $80, $78

RupeeStashYs
            db    $70, $80, $80, $90, $90, $90, $90, $A0
            db    $A0, $B0

InitRupeeStash_Full ENT
...
TrapXs
            db    $20, $20, $D0, $D0, $40, $B0

TrapYs
            db    $5D, $BD, $5D, $BD, $8D, $8D
...
StatusBarTransferBufTemplate
            db    $20, $B6, $08, $24, $24, $24, $24, $24
            db    $24, $24, $24, $20, $D6, $08, $24, $24
            db    $24, $24, $24, $24, $24, $24, $20, $6C
            db    $03, $21, $00, $24, $20, $AC, $03, $21
            db    $00, $24, $20, $CC, $03, $21, $00, $24
            db    $FF

World_ChangeRupees ENT
    LDA TileBufSelector
    ...
    CMP #$FF
    BNE :Anon0031                      ; If 0 < rupees < $FF, don't reset anything.
...
ReverseDirections ENT
            db    $08, $04, $02, $01

SaveFileAAddressSets
            db    $1A, $60, $92, $60, $02, $60, $12, $65
            db    $15, $65, $18, $65, $1B, $65

SaveFileAAddressSet1
            db    $42, $60, $12, $62, $0A, $60, $13, $65
            db    $16, $65, $19, $65, $1C, $65

SaveFileAAddressSet2
            db    $6A, $60, $92, $63, $12, $60, $14, $65
            db    $17, $65, $1A, $65, $1D, $65
...
; [0F]: untouched, or 0
;
CheckPersonBlocking ENT
    LDA ObjY
    CMP #$8E
    BCS :Anon0042                      ; Return if Y coordinate >= $8E.
    LDA $0F
    AND #$08
    BEQ :Anon0042                      ; If not moving up, then return.
    JMP ResetMovingDir
...
SpriteRelativeExtents ENT
            db    $08, $00

ShowLinkSpritesBehindHorizontalDoors ENT
    LDY #$0A
    LDX #$00
    LDA ObjX, X
    STA $00
...
;
BoundDirectionHorizontally ENT
...
;
AddQSpeedToPositionFraction ENT
    LDA ObjPosFrac, X
    CLC
    ADC ObjQSpeedFrac, X
    STA ObjPosFrac, X
...
;
SubQSpeedFromPositionFraction ENT
    LDA ObjPosFrac, X
    SEC
    SBC ObjQSpeedFrac, X
    STA ObjPosFrac, X
...
;
GetDirectionsAndDistancesToTarget ENT
...
; X: object index
;
PlaceWeaponForPlayerStateAndAnimAndWeaponState ENT
    STA ObjState, X

PlaceWeaponForPlayerStateAndAnim ENT
...
; Y: Y coordinate of shortcut (OW) or item (UW)
;
GetShortcutOrItemXYForRoom ENT
...
UpdatePlayerPositionMarker ENT
...
:Anon0059
    ...
    LDY CurLevel
    CPY #$09
    BEQ :Anon0060                      ; If you're in level 9, use the "active" palette only.
    LDA InvTriforce
    AND LevelMasks-1, Y
...
UpdateWorldCurtainEffect_Bank2 ENT
...
ItemIdToSlot ENT
            db    $01, $00, $00, $00, $06, $05, $04, $04
            db    $02, $02, $03, $0D, $09, $0C, $1B, $1C
            db    $08, $0A, $0B, $0B, $0E, $0F, $10, $11
            db    $16, $17, $18, $1A, $1F, $1D, $1E, $07
            db    $07, $15, $19, $14
...
;
ItemIdToDescriptor ENT
            db    $14, $21, $22, $23, $01, $01, $21, $22
            db    $21, $22, $01, $01, $01, $01, $01, $15
            db    $01, $01, $21, $22, $01, $01, $01, $01
            db    $11, $11, $10, $01, $01, $01, $01, $11
            db    $22, $01, $10, $12
...
;
ItemSlotToPaletteOffsetsOrValues ENT
            db    $FF, $01, $FF, $00, $00, $02, $02, $00
            db    $01, $00, $02, $00, $00, $02, $02, $01
            db    $02, $02, $02, $02, $02, $02, $02, $02
            db    $02, $02, $02, $02, $01, $00, $01, $00
...
:Anon0069
    ...
    CLC
    ADC Items, Y
    BCC :Anon0070                      ; If the sum overflowed,
...
TakeClass0Complex
    ...
    CPY #$11                    ; Map item slot
    BNE :Anon0073                      ; If it's the map item slot,
...
:Anon0073
    ...
    CMP #$08
    BCC :Anon0074                      ; If the result >= 8, we're in level 9,
...
AnimateWorldFading ENT
    ...
    LDA FadeCycle
    BPL :Anon0075                      ; If the cycle number is negative, then this is a reverse fade.
    EOR #$83
:Anon0075
...
BlankPrioritySpriteTemplates
            db    $3D, $1C, $20, $00, $DD, $1C, $20, $00

WriteBlankPrioritySprites ENT
...
ObjAnimations
            db    $00, $08, $0B, $0F, $13, $17, $5C, $60
            db    $1B, $1B, $21, $21, $64, $6A, $27, $29
            db    $2B, $35, $3F, $70, $74, $76, $76, $78
            db    $7A, $7E, $80, $49, $82, $84, $86, $4B
            db    $4F, $4F, $51, $51, $88, $8C, $90, $90
            db    $92, $94, $96, $98, $99, $99, $99, $53
            db    $54, $9A, $9B, $9B, $A5, $A5, $AB, $AB
            db    $AC, $AE, $AE, $AF, $AF, $B2, $B8, $B8
            db    $08, $08, $C6, $C6, $C6, $C6, $C6, $C6
            db    $C8, $C8, $C9, $C9, $CA, $CA, $CA, $CA
            db    $CA, $CA, $CA, $CA, $09, $09, $0A, $0A
            db    $0B, $0B, $0B, $0B, $0B, $0B, $CB, $55
            db    $55, $55, $55, $55, $55, $55, $56, $57
            db    $57, $CB, $CC, $58, $58, $58, $58, $58
            db    $58, $58, $58, $58, $59, $59, $59, $59
            db    $5A, $5A, $5A, $5A, $5B, $5B, $5B

ObjAnimFrameHeap
            db    $00, $04, $08, $0C, $10, $10, $14, $18
            db    $5C, $9E, $44, $CE, $D2, $D6, $DA, $CE
            db    $D2, $D6, $DA, $F0, $F4, $F8, $FC, $F0
            db    $F4, $F8, $FC, $B4, $B0, $B0, $B8, $B2
            db    $B2, $B4, $B0, $B0, $B8, $B2, $B2, $CA
            db    $CC, $CA, $CC, $BC, $BE, $C0, $C0, $C2
            db    $C4, $C0, $C0, $BC, $BE, $BC, $BE, $C0
            db    $C0, $C2, $C4, $C0, $C0, $BC, $BE, $BC
            db    $BE, $EC, $EE, $EC, $EE, $EC, $EE, $BC
            db    $BE, $C6, $C8, $A0, $A8, $A4, $AC, $90
            db    $E8, $E4, $E0, $94, $F3, $C9, $BD, $C1
            db    $98, $9A, $9C, $F8, $B8, $BC, $B0, $B4
            db    $B8, $BC, $B0, $B4, $B8, $AC, $B4, $BC
            db    $B0, $B4, $B8, $AC, $B4, $BC, $B0, $B4
            db    $AC, $AE, $B0, $B2, $A8, $AA, $92, $94
            db    $A0, $A2, $A6, $A4, $A2, $A4, $D8, $DA
            db    $00, $00, $9A, $9C, $9A, $9C, $9A, $9C
            db    $B4, $B8, $BC, $BE, $B4, $B8, $BC, $BE
            db    $FC, $FE, $AC, $9C, $A0, $A4, $A0, $A4
            db    $A8, $8E, $A4, $DC, $E0, $E4, $E8, $EC
            db    $F0, $F4, $F8, $FA, $FE, $F4, $F6, $FE
            db    $FC, $F0, $F8, $B0, $F6, $F0, $D4, $FC
            db    $FE, $F8, $E8, $EA, $E0, $E4, $EC, $EC
            db    $D0, $D4, $D8, $DC, $E0, $E4, $C0, $C8
            db    $C4, $CC, $E8, $EA, $72, $74, $DE, $EE
            db    $F8, $96, $98, $B1

ObjAnimAttrHeap
            db    $00, $00, $00, $00, $00, $00, $00, $00
            db    $02, $00, $00, $01, $01, $01, $01, $02
            db    $02, $02, $02, $03, $03, $03, $03, $02
            db    $02, $02, $02, $02, $82, $02, $02, $82
            db    $02, $01, $81, $01, $01, $81, $01, $01
            db    $01, $02, $02, $02, $02, $01, $01, $01
            db    $01, $01, $01, $02, $02, $02, $02, $02
            db    $02, $02, $02, $02, $02, $02, $02, $03
            db    $03, $03, $03, $03, $03, $03, $03, $03
            db    $03, $02, $02, $02, $02, $02, $02, $02
            db    $02, $01, $01, $01, $02, $03, $03, $03
            db    $02, $02, $00, $02, $01, $01, $01, $01
            db    $02, $02, $02, $02, $02, $02, $02, $02
            db    $02, $02, $01, $01, $01, $01, $01, $01
            db    $01, $01, $01, $01, $03, $03, $03, $03
            db    $00, $00, $02, $02, $02, $02, $03, $03
            db    $03, $03, $01, $01, $02, $02, $03, $03
            db    $01, $01, $01, $01, $02, $02, $02, $02
            db    $01, $01, $01, $01, $02, $02, $02, $02
            db    $02, $02, $01, $03, $03, $03, $03, $03
            db    $03, $03, $03, $03, $03, $01, $01, $01
            db    $01, $01, $01, $02, $00, $00, $03, $01
...
SpriteOffsets ENT
            ...
            db    $A0, $FC, $A4, $F8, $A8, $F4, $AC, $F0
            db    $60

AnimateAndDrawObjectWalking ENT
...
DrawObjectWithAnimAndSpecificSprites ENT
...
Anim_WriteSpritePairNotFlashing ENT
...
Anim_ItemFrameOffsets
            db    $00, $03, $07, $0A, $0B, $0C, $0D, $0E
            db    $0F, $11, $12, $13, $14, $15, $16, $17
            db    $18, $17, $18, $17, $19, $1B, $1C, $1D
            db    $1E, $1F, $20, $21, $1C, $22, $22, $26
            db    $27, $28, $29, $2B, $2E

Anim_ItemFrameTiles
            db    $20, $82, $3C, $34, $70, $72, $74, $28
            db    $86, $3C, $2A, $26, $24, $22, $40, $4A
            db    $8A, $6C, $42, $46, $76, $2C, $4E, $4C
            db    $6A, $50, $52, $66, $32, $2E, $68, $F3
            db    $6E, $F2, $36, $38, $3A, $3C, $56, $48
            db    $78, $20, $82, $7A, $7C, $30, $64, $62
...
; [01]: Y
;
Anim_WriteStaticItemSpritesWithAttributes ENT
    JSR Anim_SetSpriteDescriptorAttributes
    LDA #$00
...
; [52]: ProcessedNarrowObj
;
Anim_WriteSpecificItemSprites ENT
...
:Narrow
    ...
    BNE :Anon0081                      ; If not left-aligning a half-width object,
...
; [05]: right sprite attributes
;
Anim_SetSpriteDescriptorRedPaletteRow ENT
    LDA #$02
...
; Doesn't change A.
;
Anim_SetSpriteDescriptorAttributes ENT
    STA $04
    STA $05
    RTS
...
; X: object index
;
Anim_WriteLevelPaletteSprite ENT
    LDY #$03
    STY $03
...
ObjTypeToDamagePoints
            db    $60, $02, $01, $80, $80, $01, $80, $80
            db    $80, $80, $80, $01, $02, $80, $80, $01
            db    $80, $80, $01, $01, $80, $80, $02, $01
            db    $02, $00, $80, $80, $80, $80, $01, $80
            db    $80, $01, $01, $02, $01, $02, $02, $80
            db    $80, $80, $80, $00, $00, $00, $00, $00
            db    $02, $01, $01, $02, $02, $00, $00, $00
            db    $02, $02, $02, $02, $01, $01, $04, $80
            db    $80, $80, $01, $01, $01, $01, $01, $02
            db    $02, $01, $01, $00, $00, $00, $00, $00
            db    $00, $00, $00, $80, $80, $80, $01, $02
            db    $02, $04, $04, $80, $01
...
; A: 0
;
ResetShoveInfoAndInvincibilityTimer ENT
...
; [00]: weapon slot
;
CheckMonsterSwordShotOrMagicShotCollision ENT
    STY $00                     ; [00] holds the weapon slot
...
; [00]: weapon slot
;
CheckMonsterBombOrFireCollision ENT
    STY $00                     ; [00] holds the weapon slot
...
; [06]: 1 if objects collide
;
CheckMonsterSwordCollision ENT
    STY $00                     ; [00] holds the weapon slot
